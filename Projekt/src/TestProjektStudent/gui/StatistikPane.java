...
public class StatistikPane extends GridPane {
	...
	private final TextField txfVægtTil = new TextField();
	private final ComboBox<Laegemiddel> lstLægemidler = new ComboBox<>();
	...
	public void updateDetails() {
		try {
			int vFra = Integer.parseInt(txfVægtFra.getText());
			int vTil = Integer.parseInt(txfVægtTil.getText());
			Laegemiddel lægemiddel = lstLægemidler.getSelectionModel().getSelectedItem();
			int antal = Controller.antalOrdinationerPrVaegtPrLaegemiddel(vFra, vTil, lægemiddel);
